...
//            System.out.println("board DAO is : "+boardDAO.getList(pageMap));
//            
//
...
//            
            request.setAttribute("getList", boardDAO.getList());
